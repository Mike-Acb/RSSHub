...
const thirdPartySupportedAPI = ['UserByScreenName', 'UserByRestId', 'UserTweets', 'UserTweetsAndReplies', 'UserRepliesTimeline', 'TweetDetail', 'ListLatestTweetsTimeline', 'SearchTimeline', 'UserMedia'];
...
const gqlFeatures = {
    ...
    UserRepliesTimeline: gqlFeatureFeed,
