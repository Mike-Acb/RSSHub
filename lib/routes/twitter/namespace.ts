...
| \`detail\`                          | Include parent conversation posts for replies in \`/twitter/user\` when \`includeReplies\` is enabled; requires Web API or a third-party GraphQL API | \`0\`/\`1\`/\`true\`/\`false\` | \`false\`                                   |
