...
| \`includeReplies\`               | Include replies while retaining tweets from the main user timeline, only available in \`/twitter/user\`                                                        | \`0\`/\`1\`/\`true\`/\`false\` | \`false\`                                   |
| \`detail\`                       | Expand each tweet into its full conversation (the tweet it replies to plus the replies below it), requires \`includeReplies\`; costs one extra API request per tweet | \`0\`/\`1\`/\`true\`/\`false\` | \`false\`                                   |
